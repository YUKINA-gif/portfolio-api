...
class PortfolioSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            "created" => "7日",
            "url" => "https://app-todolist-yn.netlify.app",
        ...
        $param = [
            ...
            "created" => "18日",
            "url" => "https://albumshare.netlify.app",
        ...
        $param = [
            ...
            "created" => "2ヶ月",
            "url" => "https://rese-booking.netlify.app",
        ...
        $param = [
            ...
            "created" => "7日",
            "url" => "https://fes-live.netlify.app",
            "detail" => "趣味でのイベントの開催日をよく忘れてしまうため自分でアプリを作ることにしました。",
